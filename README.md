...
```
**Note:** This step will take about **two hours**. The output results will be stored in the folder named `results` by default. Of course, you can add the parameter `--outdir` to set the folder where the output results will be stored. Please refer to the **Help Message** section or execute `nextflow run metatranscriptome.nf --help` in the terminal to view the detailed information of parameter passing.
## Help Message
